                ...
                <div className="relative z-10 p-8 md:p-12">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className={cn("font-medium text-sm max-w-xs", "text-muted-foreground")}>
                                Engineered in Morocco
                                <span className={cn("inline-block ml-2 text-xs px-1.5 py-0.5 rounded font-mono", "bg-secondary text-secondary-foreground")}>MA</span>
                            </p>
                            <Button
                                variant="outline"
                                size="sm"
                        ...
                        <div className="space-y-6">
                            ...
                            <div className={cn(
                                ...
                                <div className={cn("flex items-center gap-3 text-sm font-medium", "text-foreground")}>
                                ...
                                <div className={cn("flex items-center gap-3 text-sm font-mono", "text-muted-foreground")}>
